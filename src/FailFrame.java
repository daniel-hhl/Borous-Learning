...
public class FailFrame extends JFrame implements ActionListener {
	...
	private JLabel frameBackground = new JLabel(new ImageIcon("frameimages/failPicture.png"));
	...
	// constructor method
	public FailFrame(int lessonCompleted, int activityCompleted) {
		...
		// these methods are called to create the JButtons and JFrame
		// properties, and place them on the frame
		placeButtons();
		setupFrame();
	}

	// this method sets the properties of the frame and sets the bounds so the
	...
	private void placeButtons() {
		...
		for (int i = 0; i < buttonArray.length; i++) {
			...
			buttonArray[i].setBounds(94 + i * 219, 520, 200, 51);
		}
	...
	// this method sets the properties of the frame, adding all widgets
	...
	public void actionPerformed(ActionEvent e) {
		// if the source is from a button, create new instance of the
