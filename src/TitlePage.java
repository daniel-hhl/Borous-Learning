...
public class TitlePage extends JFrame implements ActionListener {
	...
	private JLabel frameBackground = new JLabel(new ImageIcon("frameimages/mainMenu.png"));
	...
	// constructor method
	public TitlePage(int lessonCompleted, int activityCompleted) {
	...
	private void placeButtons() {
		...
		for (int i = 0; i < buttonArray.length; i++) {
			...
			buttonArray[i].setFont(new Font("Dialog", Font.BOLD, 13));
			...
			buttonArray[i].setBounds(107 + i * 212, 517, 187, 51);
		}
