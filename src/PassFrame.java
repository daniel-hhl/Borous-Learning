...
public class PassFrame extends JFrame implements ActionListener {
	...
	private JLabel frameBackground = new JLabel(new ImageIcon("frameimages/passPicture.png"));
	...
	// constructor method
	public PassFrame(int lessonCompleted, int activityCompleted) {
	...
	private void placeButtons() {
		...
		for (int i = 0; i < buttonArray.length; i++) {
			...
			buttonArray[i].setBounds(99 + i * 219, 511, 200, 51);
		}
