...
public class Lesson3 extends JFrame implements ActionListener {
	...
	private JLabel lessonLabel = new JLabel(new ImageIcon("frameimages/Lesson3.png"));
	...
	// constructor method
	public Lesson3(int lessonCompleted, int activityCompleted) {
	...
	private void scrollPage() {
		...
		scrollPanel.setPreferredSize(new Dimension(1200, 2600));
		...
		lessonLabel.setBounds(0, 0, 1200, 2600);
	}
	...
	private void placeButtons() {
		...
		// are not correlated
		buttonArray[0].setBounds(1035, 20, 117, 51);
		buttonArray[1].setBounds(532, 2517, 136, 51);
