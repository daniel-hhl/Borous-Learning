...
public class Lesson2 extends JFrame implements ActionListener {
	...
	private JLabel lessonLabel = new JLabel(new ImageIcon("frameimages/Lesson2.png"));
	...
	// constructor method
	public Lesson2(int lessonCompleted, int activityCompleted) {
	...
	private void scrollPage() {
		...
		scrollPanel.setPreferredSize(new Dimension(1200, 3000));
		...
		lessonLabel.setBounds(0, 0, 1200, 3000);
	}
	...
	private void placeButtons() {
		...
		// are not correlated
		buttonArray[0].setBounds(1033, 20, 117, 51);
		buttonArray[1].setBounds(532, 2918, 136, 51);
